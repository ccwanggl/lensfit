...
## 关键关系
- 相关概念：[[./005-f-number|F值]]（F# = f/D，焦距是分子）、[[./007-depth-of-field|景深]]（焦距越长景深越浅）
- 相关公式：薄透镜公式、视角公式
- 相关教程：[[../50-learning/002-geometric-optics|第2章 几何光学]]（薄透镜公式、放大倍率、视角）、[[../50-learning/003-lens-parameters|第3章 镜头参数]]（镜头参数速查表）
...
## 来源
- [[../50-learning/002-geometric-optics|第2章 几何光学]] §2.2 薄透镜成像模型
- [[../50-learning/003-lens-parameters|第3章 镜头参数]] §3.1 焦距
