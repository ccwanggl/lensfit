...
衍射极限是由光的波动性质决定的分辨率上限。即使镜头没有像差、没有失焦，点光源经过有限孔径后也会形成有限大小的点扩散函数，圆孔成像中最典型的形态是 [[10-concepts/airy-disk|艾里斑]]。
...
- **采样限制**来自传感器像元大小和采样频率，常用 [[10-concepts/nyquist-frequency|奈奎斯特频率]] 判断。
