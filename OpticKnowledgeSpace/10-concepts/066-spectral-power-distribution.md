...
- 相关概念：[[./067-color-temperature|色温]]（由 SPD 匹配黑体辐射得到）
- 相关概念：[[./069-chromaticity-diagram|色度图]]（色度坐标由 SPD 计算）
- 相关设备：[[../40-devices/011-spectrometer|光谱仪]]（SPD 测量工具）
- 相关设备：[[../40-devices/014-integrating-sphere|积分球]]（均匀收集 SPD 的光）
