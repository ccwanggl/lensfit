...
- 相关概念：[[./073-hyperspectral-imaging|高光谱成像]]（波段更多、连续）
- 相关概念：[[./074-spectral-resolution|光谱分辨率]]
- 相关领域：[[../30-domains/005-on-chip-multispectral|片上多光谱成像]]（集成化实现方向）
- 相关设备：[[../40-devices/012-hyperspectral-camera|高光谱相机]]（部分设备支持多光谱模式）
- 相关设备：[[../40-devices/009-bandpass-filter|窄带滤光片]]（多光谱成像常用滤光片组合）
