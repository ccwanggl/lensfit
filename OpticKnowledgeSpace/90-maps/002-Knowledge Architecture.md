...
推荐入口：[[001-Learning Path|从零到深入学习路径]]。
...
1. [[50-learning/001-light-and-waves|第1章：光与波]]
2. [[10-concepts/017-dispersion|色散]]
3. [[10-concepts/066-spectral-power-distribution|光谱分布函数]]
4. [[50-learning/016-spectroscopy|第16章：光谱学与色彩科学]]
5. [[30-domains/004-spectroscopy|光谱成像]]
6. [[40-devices/011-spectrometer|光谱仪]] 和 [[40-devices/012-hyperspectral-camera|高光谱相机]]
7. [[30-domains/005-on-chip-multispectral|片上多光谱成像]]（专项深入，可选）
8. [[10-concepts/075-snapshot-spectral-imaging|快照式光谱成像]]、[[10-concepts/076-multispectral-filter-array|多光谱滤光片阵列]]、[[10-concepts/077-fabry-perot-microcavity|Fabry–Pérot 微腔]]、[[10-concepts/078-metasurface|超表面]]、[[10-concepts/079-spectral-reconstruction|光谱重建]]（按需深入）
