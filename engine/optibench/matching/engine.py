...
from optibench.core.types import FilterDiagnostic, MatchingTask, MatchResult, PhysicsTrace
from optibench.core.utils import is_mount_compatible, nyquist_match, sensor_coverage_check
from optibench.db.catalog import CatalogQuery
from optibench.db.models import DetectorCatalog, LensCatalog
from optibench.domains.base import DeviceCombo, DomainModule, Requirements
from optibench.knowledge.engine import KnowledgeInferenceEngine, OpticalKnowledgeBase
from optibench.matching.scoring import ScoringEngine, TopsisRanker
...
class MatchingEngine:
    ...
    def __init__(self, session_factory: Callable[[], Session] | None = None):
        ...
        self._executor = ThreadPoolExecutor(
            max_workers=4, thread_name_prefix="optibench-match"
        )
    ...
    def index_pre_filter(
        ...
        from optibench.core.sensor import sensor_size_from_format
    ...
    def rank_results(
        ...
        # 将通用维度也加入排序维度列表
        from optibench.domains.base import ScoringDimension
        all_dims = list(dims)
        all_dims.append(
            ScoringDimension(
