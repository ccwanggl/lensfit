...
from optibench.db.models import DetectorCatalog, LensCatalog, Project, ProjectSetup
    ...
    try:
        if req.format == "pdf":
            ...
            return FastAPIResponse(
                ...
                headers={
                    "Content-Disposition": (
                        f"attachment; filename=optibench-project-{project_id}-report.pdf"
                    ),
                },
            )
        else:
            ...
            return FastAPIResponse(
                ...
                headers={
                    "Content-Disposition": (
                        f"attachment; filename=optibench-project-{project_id}-report.xlsx"
                    ),
                },
            )
