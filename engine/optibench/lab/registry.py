"""Experiment registry for OptiBench optics lab."""
...
from optibench.lab import experiments
from optibench.lab.base import ExperimentInfo, ExperimentResult, OpticsExperiment


class ExperimentRegistry:
    """Registry of all available optics experiments.

    Experiments are discovered dynamically by scanning ``optibench.lab.experiments``
